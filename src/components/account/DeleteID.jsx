  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <div className="text-xs">
        <ul className="flex flex-col text-left text-nowrap">
          <li className="text-center">탈퇴 약관</li>
          <li className="flex flex-col items-start">제 1조 (목적)
            <p className="text-[10px] ">
              본 약관은 [밋?잇!]의 회원 탈퇴 절차 및 관련 사항을 규정함을 목적으로 합니다.
            </p>
          </li>
          <li className="flex flex-col">제 2 조 (회원 탈퇴 신청)
            <p className="text-[10px]">
          ...
          <li className="flex flex-col items-start">제 3 조 (탈퇴 후 이용 제한)
            <p className="text-[10px]">
          ...
          <li className="flex flex-col items-start">제 4 조 (개인정보 처리)
            <p className="text-[10px]">
          ...
          <li className="flex flex-col items-start">제 5 조 (약관의 개정 및 고지)
            <p className="text-[10px]">
          ...
          <li className="flex flex-col items-start">부칙
            <p className="text-[10px]">
              본 약관은 [시행일]부터 시행됩니다.
            </p>
          </li>
